...
class ProjectControllerTest {
    ...
    private static String makeRequest() {
        ...
        map.add("client_secret", "VG2soKsH0aAIgitZGiEvHduYZ7mN3IZo");
        ...
        ResponseEntity<ResponseDTO> response =
                restTemplate.exchange("http://localhost:8080/auth/realms/cybertek-dev/protocol/openid-connect/token",
                        HttpMethod.POST,
                        entity,
                        ResponseDTO.class);
